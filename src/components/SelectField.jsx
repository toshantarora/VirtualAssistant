      ...
      >
        <div className="relative">
          ...
          >
            <ComboboxOptions 
              className="
                absolute z-100 mt-2 max-h-60 w-full overflow-auto 
                  ...
                  {filteredOptions.map((option) => (
                    <ComboboxOption
                      ...
                      className={({ focus, selected }) => `
                        ...
                        ${focus ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'text-slate-700 hover:bg-slate-50'}
                    ...
                    >
                      {({ selected, focus }) => (
                        <>
                          <span className={`block truncate ${selected ? 'font-bold' : option.value === '' ? 'font-bold' : 'font-semibold'} text-sm`}>
                            {option.label}
                          </span>
                          {selected && (
