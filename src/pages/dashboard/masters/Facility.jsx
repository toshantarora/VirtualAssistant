...
const Facility = () => {
  ...
  const closeModal = () => {
    ...
    setTimeout(() => {
      setEditingLocation(null);
      reset({ facility: '', wardId: '', countryFilter: selectedCountryFilter, provinceFilter: selectedProvinceFilter, districtFilter: selectedDistrictFilter, constituencyFilter: selectedConstituencyFilter, wardFilter: selectedWardFilter });
    }, 0);
  };
